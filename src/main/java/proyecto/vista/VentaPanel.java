...
public class VentaPanel extends JPanel implements ActionListener, ItemListener, ListSelectionListener, CaretListener {
	...
	private class VentaTableModel extends AbstractTableModel {
		...
		private ArrayList<DetallesVenta> datos = new ArrayList<DetallesVenta>();
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			DetallesVenta detalles = datos.get(rowIndex);
			switch (columnIndex) {
			case 0:
	...
	public void crearGUI() {
		...
		cancelar = new JButton("Cancelar Venta");
		...
		tabla = new JTable(new VentaTableModel());
	...
	public void llenarTabla(ArrayList<DetallesVenta> detalles) {
		VentaTableModel modelo = ((VentaTableModel) tabla.getModel());
	...
	public void setVideojuegosEnELCombo(ArrayList<Videojuego> videojuegos) {
		...
		for (Videojuego vid : videojuegos) {
			String string = "" + vid.getId() + " - " + vid.getNombre() + " - " + vid.getConsola() + " - "
					+ vid.getClasificacion() + " - " + vid.getPrecio() + " - Stock: " + vid.getStock();
			strings.add(string);
		}
	...
	public void setControlador(VentaControlador cont) {
